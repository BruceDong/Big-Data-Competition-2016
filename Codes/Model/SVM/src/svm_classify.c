...
void read_input_l_parameters(int, char **, char *, char *, char *, long *,
			   long *);
void print_l_help(void);
...
int svm_regression(int argc, char* argv[])
{
char docfile[200];
char modelfile[200];
  ...
  read_input_l_parameters(argc,argv,docfile,modelfile,predictionsfile,
...
void read_input_l_parameters(int argc, char **argv, char *docfile,
